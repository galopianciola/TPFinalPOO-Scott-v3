        ...
        if(Main.encargadoLogeado.getDni()==1)
            ...
            try {
                if (Main.encargadoLogeado.getArea().getDeporte().equals("Basquet"))
                    m.changeScene("src/main/java/ui/Areas/deporte.fxml", "Basquet");
                else
        ...
        if(Main.encargadoLogeado.getDni()==1)
            ...
            try {
                if (Main.encargadoLogeado.getArea().getDeporte().equals("Futbol"))
                    m.changeScene("src/main/java/ui/Areas/deporte.fxml", "Futbol");
                else
                    m.sendAlert(Alert.AlertType.ERROR, "Acceso denegado,", "No es posible ingresar al área seleccionada");
            } catch (Exception e) {
                e.printStackTrace();
        ...
        if(Main.encargadoLogeado.getDni()==1)
            ...
            try {
                if (Main.encargadoLogeado.getArea().getDeporte().equals("Paddle"))
                    m.changeScene("src/main/java/ui/Areas/deporte.fxml", "Paddle");
                else
                    m.sendAlert(Alert.AlertType.ERROR, "Acceso denegado,", "No es posible ingresar al área seleccionada");
            } catch (Exception e) {
                e.printStackTrace();
        ...
        if(Main.encargadoLogeado.getDni()==1)
            ...
            try {
                if (Main.encargadoLogeado.getArea().getDeporte().equals("Tenis"))
                    m.changeScene("src/main/java/ui/Areas/deporte.fxml", "Tenis");
                else
                    m.sendAlert(Alert.AlertType.ERROR, "Acceso denegado,", "No es posible ingresar al área seleccionada");
            } catch (Exception e) {
                e.printStackTrace();
        ...
        if(Main.encargadoLogeado.getDni()==1)
            ...
            try {
                if (Main.encargadoLogeado.getArea().getDeporte().equals("Voley"))
                    m.changeScene("src/main/java/ui/Areas/deporte.fxml", "Voley");
                else
                    m.sendAlert(Alert.AlertType.ERROR, "Acceso denegado,", "No es posible ingresar al área seleccionada");
            } catch (Exception e) {
                e.printStackTrace();
